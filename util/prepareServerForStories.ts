...
export default () => {
  ...
  localStorage.token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MjVlMTJlNTNmMDVmNGIzODA1N2ZmOTYiLCJpYXQiOjE2NTAzMzI0MjEsImV4cCI6MTY2MDcwMDQyMX0.d0GXFo3xxrCRcnyANUKJkCIyzFUq9GsnNvuzBW6knc0";
};
