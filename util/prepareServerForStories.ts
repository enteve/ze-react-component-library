...
export default () => {
  ...
  localStorage.token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MTY2ZDA1NDJmZmQyNjNmYzE2NTBlYmUiLCJpYXQiOjE2MzU3Mzg5NTYsImV4cCI6MTYzNjM0Mzc1Nn0.YI8R9JVYYB8KtZ816lB9hxBTvFTgDWoUy4PLaCato4E";
};
