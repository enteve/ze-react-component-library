...
export default () => {
  ...
  config.API_URL = "https://jaem.yiwendata.com";
  localStorage.token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MGY5MDAxYzJiMjI2NDE3NTA2MmU0NTIiLCJpYXQiOjE2NTMyOTYyNjIsImV4cCI6MTY2MzY2NDI2Mn0.BZ-XgbGmMbWwIyiw5SH47Pr9vPNf7RyyLEyI4oib8ek";
};
